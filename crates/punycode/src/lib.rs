...
fn punycode_decode_part(input: &[u8]) -> Result<String, DecodingError> {
    ...
    let mut position = last_delimiter;
    if last_delimiter > 0 {
        position += 1;
    }
...
mod tests {
    ...
    /// <https://github.com/golang/net/blob/v0.33.0/idna/punycode_test.go#L171>
    #[test]
    ...
    /// <https://github.com/golang/net/blob/v0.33.0/idna/punycode_test.go#L172>
    #[test]
    ...
    /// <https://github.com/golang/net/blob/v0.33.0/idna/punycode_test.go#L173>
    #[test]
    ...
    /// <https://github.com/golang/net/blob/v0.33.0/idna/punycode_test.go#L174>
    #[test]
    ...
    /// <https://github.com/golang/net/blob/v0.33.0/idna/punycode_test.go#L175>
    #[test]
    ...
    /// <https://github.com/golang/net/blob/v0.33.0/idna/punycode_test.go#L176>
    #[test]
    ...
    /// <https://github.com/golang/net/blob/v0.33.0/idna/punycode_test.go#L177>
    #[test]
