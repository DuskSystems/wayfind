...
/// Search needs cache.
const NEEDS_CACHE: u8 = 1 << 1;

/// All dynamic children are full segments.
const DYNAMIC_SEGMENT_ONLY: u8 = 1 << 2;

/// All wildcard children are full segments.
const WILDCARD_SEGMENT_ONLY: u8 = 1 << 3;
...
impl Flags {
    ...
    #[inline(always)]
    pub(crate) const fn is_needs_cache(self) -> bool {
        self.0 & NEEDS_CACHE != 0
    }

    #[inline(always)]
    pub(crate) const fn set_needs_cache(&mut self, value: bool) {
        self.set(NEEDS_CACHE, value);
    }
