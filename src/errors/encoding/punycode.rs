...
pub enum PunycodeEncodingError {
    /// Invalid basic code point encountered (non-ASCII character).
    ///
    /// # Examples
    ///
    /// ```rust
    /// use wayfind::errors::PunycodeEncodingError;
    ///
    /// let error = PunycodeEncodingError::InvalidBasicCodePoint {
    ...
    /// use wayfind::errors::PunycodeEncodingError;
    ///
    /// let error = PunycodeEncodingError::InvalidDigit {
    ///     input: "hello-@world".to_string(),
    ///     position: 6,
    ///     character: b'@',
    /// };
    ...
    /// use wayfind::errors::PunycodeEncodingError;
    ///
    /// let error = PunycodeEncodingError::UnexpectedEnd {
    ...
    /// use wayfind::errors::PunycodeEncodingError;
    ///
    /// let error = PunycodeEncodingError::Overflow {
    ...
    /// use wayfind::errors::PunycodeEncodingError;
    ///
    /// let error = PunycodeEncodingError::InvalidCodePoint {
...
impl Error for PunycodeEncodingError {}

impl Display for PunycodeEncodingError {
